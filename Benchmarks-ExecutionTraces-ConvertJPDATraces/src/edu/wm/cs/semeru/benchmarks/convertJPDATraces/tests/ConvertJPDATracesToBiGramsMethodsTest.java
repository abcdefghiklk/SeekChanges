...
public class ConvertJPDATracesToBiGramsMethodsTest extends TestCase 
{
	...
	protected void setUp() {
		fileName1Path="TestCases/Output/jEdit4.3/BiGramsMethodsTraces/";
		fileNames=new String[]{
			"1500938.BiGramsMethodsTrace",
		};
		fileName2Path="TestCases/CorrectResultsOracle/jEdit4.3/BiGramsMethodsTraces/";
	}
	...
	{
	    return new TestSuite(ConvertJPDATracesToBiGramsMethodsTest.class);
	}
}
