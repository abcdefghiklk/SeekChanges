...
public class jEditSVNDownloadTest extends TestCase 
{
	...
	protected void setUp() {
		inputPathOracle="TestCases/CorrectResultsOracle/jEdit/";
		...
		inputPathOutput="TestCases/Output/jEdit/";
	...
	public void testEqualFileNumbers() throws Exception {
		assertEquals(19,listOfFiles.size());
	}
	...
	{
	    return new TestSuite(jEditSVNDownloadTest.class);
	}
}
