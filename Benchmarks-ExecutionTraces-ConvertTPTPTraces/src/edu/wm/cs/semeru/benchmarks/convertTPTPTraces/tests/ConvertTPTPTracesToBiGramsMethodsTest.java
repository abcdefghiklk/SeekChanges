...
public class ConvertTPTPTracesToBiGramsMethodsTest extends TestCase 
{
	...
	protected void setUp() {
		fileName1Path="TestCases/Output/ArgoUML0.22/BiGramsMethodsTraces/";
		fileNames=new String[]{
			"4298.BiGramsMethodsTrace",
		};
		fileName2Path="TestCases/CorrectResultsOracle/ArgoUML0.22/BiGramsMethodsTraces/";
	}
	...
	{
	    return new TestSuite(ConvertTPTPTracesToBiGramsMethodsTest.class);
	}
}
