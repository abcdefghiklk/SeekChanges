...
public class InputOutputConvertTPTPTraces
{
	...
	public InputOutputConvertTPTPTraces(String fileNameListOfIssues,String folderInputTraces,String outputFolder)
	{
	...
	public InputOutputConvertTPTPTraces(String fileNameListOfIssues,String folderInputTraces,String outputFolder,String fileNameCorpusMapping)
	{
	...
	{
		return folderInputTraces+"trace"+issueID+".trcxml";
	}
