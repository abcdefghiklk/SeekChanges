...
public class UIComponentELTagUtils
{
                                        ...
                                        ValueExpression value)
    {
        if (value != null)
        {
            if (!value.isLiteralText())
            {
                component.setValueExpression(org.apache.myfaces.shared_impl.renderkit.JSFAttr.VALUE_ATTR, value);
            }
                                        ...
                                        ValueExpression value)
    {
        if (value != null)
        {
            if (component instanceof ValueHolder)
            {
                ...
                {
                    component.setValueExpression(org.apache.myfaces.shared_impl.renderkit.JSFAttr.CONVERTER_ATTR, value);
                }
            }
            else
            {
